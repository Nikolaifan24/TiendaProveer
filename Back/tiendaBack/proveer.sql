...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-12-2022 a las 22:09:36
...
CREATE TABLE `clientes` (
  `IDCliente` int(11) NOT NULL,
  `cedulaCliente` int(30) DEFAULT NULL,
...
INSERT INTO `clientes` (`IDCliente`, `cedulaCliente`, `nombreCliente`, `apellidoCliente`, `direccionCliente`, `barrioCliente`, `zonaCliente`, `telefonoCliente`, `telefonoCliente1`) VALUES
...
CREATE TABLE `proveedores` (
  ...
  `nitProveedor` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `proveedores` (`IDProveedor`, `nombreProveedor`, `nitProveedor`, `ciudadProveedor`, `direcciónProveedor`, `telefonoProveedor`, `TipoProducto`) VALUES
