...
public class ComprasDto {
    ...
    public ComprasDto(Long IDCompras, ProveedorResponse proveedores, Long CodigoCompra, String FechaCompra, Long nitProveedor, Double totalCompra, Double ivaCompra) {
