...
public class DetalleDevolucionesResponse {
    ...
    public DetalleDevolucionesResponse() {
    }

    public DetalleDevolucionesResponse(Long ID, DevolucionesResponse devoluciones, ProductoResponse productos, String nombreProducto, Double precioProducto, int Cantidad, Double ValorDevoluciones) {
        this.ID = ID;
