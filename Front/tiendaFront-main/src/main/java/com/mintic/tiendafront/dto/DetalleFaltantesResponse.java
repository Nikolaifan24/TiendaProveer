...
public class DetalleFaltantesResponse {
    ...
    public DetalleFaltantesResponse() {
    }
    

    public DetalleFaltantesResponse(Long ID, FaltantesResponse faltantes, ProductoResponse productos, String nombreProducto, Double precioProducto, int Cantidad, Double totalDetalle) {
        this.ID = ID;
