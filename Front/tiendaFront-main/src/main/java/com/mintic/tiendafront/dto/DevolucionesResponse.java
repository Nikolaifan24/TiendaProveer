...
public class DevolucionesResponse {
    ...
    public DevolucionesResponse() {
    }

    public DevolucionesResponse(Long ID, VentaResponse ventas, VendedorResponse vendedor, Long codigoVenta, String fechaVenta, String nombreVendedor, Double TotalDevoluciones) {
        this.ID = ID;
        this.ventas = ventas;
