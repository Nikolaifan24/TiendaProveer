...
public class FaltantesResponse {
    ...
    public FaltantesResponse() {
    }

    public FaltantesResponse(Long IDFaltantes, VentaResponse ventas, VendedorResponse vendedor, Long codigoventa, String fechaVenta, String nombreVendedor, Double totalFaltantes) {
