...
public class NominaDto {
    ...
    public NominaDto(Long ID, VentaResponse ventas, VendedorResponse vendedor, DevolucionesResponse devoluciones, FaltantesResponse faltantes, String nombreVendedor, Long codigoVenta, String fechaInicio, String fechaFinal, Double TotalDevoluciones, Double TotalFaltantes, Double TotalVentas, Double TotalReal) {
        this.ID = ID;
        this.ventas = ventas;
