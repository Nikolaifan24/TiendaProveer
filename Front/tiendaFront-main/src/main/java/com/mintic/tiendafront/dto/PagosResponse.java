...
public class PagosResponse {
    ...
    public PagosResponse(Long IDPagos, ClienteResponse clientes, VentaResponse ventas, String FechaVenta, String FechaPago, String TipoPago, String MedioPago, Double ValorPago) {
