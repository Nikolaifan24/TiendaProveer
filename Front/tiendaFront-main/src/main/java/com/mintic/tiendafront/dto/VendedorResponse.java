...
public class VendedorResponse {
    ...
    public VendedorResponse(Long IDVendedor, UsuarioResponse usuario, Long documentoVendedor, String nombreVendedor, String direccionVendedor, Double telefonoVendedor, Float comisionVendedor, String FechaIngreso, Double Salario) {
