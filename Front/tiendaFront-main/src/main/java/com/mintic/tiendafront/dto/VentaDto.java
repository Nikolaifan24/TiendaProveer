...
public class VentaDto {
	...
	public VentaDto(Long ID, ClienteResponse clientes, VendedorResponse vendedor, Long CodigoVenta, String FechaVenta, String FechaEntrega, Long documentoCliente, String nombreVendedor, int descuento, Double totalVenta, Double ivaVenta, String zonaventa) {
		this.ID = ID;
