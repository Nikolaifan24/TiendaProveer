...
<nav class="navbar navbar-expand-lg navbar--dark bg-dark">
	...
	<div class="container overflow-hidden">
		...
		<div class=" col-xl-2 col-lg-3 col-md-4 col-sm-6" id="formulario">
			<form method="post" action="/detallefaltantes/${CodigoVenta}">
				...
				<div class="container overflow-hidden">
					...
					<div class="form-group">
						...
						<input type="text"
							...
							value="${detalleFaltantesEditar.productos.codigoProducto}" class="form-control" />
					</div>
					<div class="form-group">
						<label for="cantidad"> Cantidad del Producto:</label>
						<input type="text"
							name="cantidad" id="cantidad"
							value="${detalleFaltantesEditar.cantidad}" class="form-control" />
		...
		<table class="table">
			...
			<tbody>
				<c:forEach items="${detallefaltantes}" var="detallefaltantes">
				
					<tr style=" color: black"> 
						
						<td>${detallefaltantes.productos.nombreProducto}</td>
						<td>${detallefaltantes.productos.codigoProducto}</td>
						<td>${detallefaltantes.cantidadProducto}</td>
						<td>${detallefaltantes.precioProducto}</td>
						<td>${detallefaltantes.totalDetalle}</td>
						
						<td><a class="btn btn-success" href="/BuscarDetalleFaltantes/${CodigoVenta}/${detallefaltantes.nombreProducto}">Editar</a></td>
						<td><a class="btn btn-danger" href="/eliminardetallefaltantes/${CodigoVenta}/${detallefaltantes.nombreProducto}">Eliminar</a></td>
